...
<div class="d-flex justify-content-between align-items-center mb-3" data-aos="fade-up">
    <h2 class="h4 mb-0">گزارش مشتریان</h2>
...
<div class="glass-card glass-table-wrap" data-aos="fade-up">
    <table class="table glass-table align-middle" style="width:100%">
        <thead><tr><th>مشتری</th><th>ارز</th><th class="text-start">صورتحساب (فیس)</th><th class="text-start">پرداخت‌شده</th><th class="text-start">باقی‌مانده</th></tr></thead>
        <tbody>
            <?php if (empty($map)): ?>
