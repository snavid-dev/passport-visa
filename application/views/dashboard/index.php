...
<div class="mb-4" style="transform: translate3d(10px, 10px, 10px) !important;" data-aos="fade-up">
...
<div class="glass-card p-4" data-aos="fade-up">
    <h3 class="h5 mb-2"><i class="fa-solid fa-rocket text-primary me-1"></i> سیستم آماده است</h3>
