...
|
*/
$config['base_url'] = env('APP_URL') ? rtrim(env('APP_URL'), '/') . '/' : 'https://passport-visa.cyborgtech.co/';
...
|
*/
$config['encryption_key'] = env('ENCRYPTION_KEY') ?: 'a7F3kQ9zX1pL6mB4vN8wR2dT5yH0sJ7c';
